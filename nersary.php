...
<body>
    ...
    <div class="header-3">
        ...
        <nav class="navbar">
            ...
            <a href="http://localhost/project2/nersaryPlant.php">login</a>
        </nav>
        <div class="icons ">
                ...
                <div class="swiper-slide">
                    <div class="box" style="background: url(Slider2.jpg);">
                        <div class="content">
                            ...
                            <a href="http://localhost/project2/nersaryPlant.php" class="btn">Shop now</a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
    ...
    <section class="product" id="Product">
        ...
        <div class="box-container">
            <div class="box">
                ...
                <a href="http://localhost/project2/nersaryPlant.php" class="btn">add to cart</a>
            </div>
            <div class="box">
    ...
    <section class="deal" id="Deal">
        ...
        <div class="row">
            <div class="content">
                ...
                <a href="http://localhost/project2/nersaryPlant.php" class="btn">check out deal</a>
            </div>
            <div class="image">
